...
class FaqChildArabicAdapter(
    private val faqList: ArrayList<MoreTabResponse.Faq.Faqs>,
    private val context: Activity,
    private val language: String?
) :
    RecyclerView.Adapter<FaqChildArabicAdapter.TodoViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TodoViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_faq_child_arbic, null)
